...
import com.kangos.device.DeviceSettings.FileUtils;
import com.kangos.device.DeviceSettings.preferences.ProperSeekBarPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.kangos.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
